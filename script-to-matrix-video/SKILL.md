...
- Rendering requires Python 3.10 or newer plus `ffmpeg` and `ffprobe` on `PATH`. The 18 `ref-` templates additionally require Node.js/npm; their wrapper pins HyperFrames `0.8.29`.
