...
Keep `assets/templates` and `assets/fonts` as well. The 13-style catalog and eight licensed Chinese font families are part of the runtime, so no separate operating-system font installation is required for bundled templates.
